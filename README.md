# Buzzard Gee Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/buzzard-gee-conjecture-canonical-lane-mathlib.git
cd buzzard-gee-conjecture-canonical-lane-mathlib
lake exe
lake build
```
